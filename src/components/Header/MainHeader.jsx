        ...
        >
          <ul className="md:flex md:items-center gap-16 text-md  md:px-0 py-4 md:py-0 font-semibold  ">
            ...
            <li className="relative group">
              ...
              <ul className="absolute hidden group-hover:block bg-white shadow-md p-2 space-y-1 w-40">
                <li>
            ...
            <li className="relative group">
              ...
              <ul className="absolute hidden group-hover:block bg-white shadow-md p-2 space-y-1 w-52">
                <li>
